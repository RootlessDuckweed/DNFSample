...
namespace FixIntPhysics
{
    public abstract class ColliderBehaviour 
    {
        ...
        public virtual void SetBoxData(float raduis, Vector3 center, bool isFollowTarget = false) { }
        public virtual void SetBoxData(FixInt raduis, FixIntVector3 center, bool isFollowTarget = false) { }
